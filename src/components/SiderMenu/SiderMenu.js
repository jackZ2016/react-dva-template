...
export default class SiderMenu extends PureComponent {
  ...
  */
  ...
  render() {
    const { logo,
      collapsed, location: { pathname }, onCollapse, changeTheme, darkTheme } = this.props;
    ...
    return (
      ...
      >
        <div className={styles.logo} id="logo" key="logo">
          <Link to="/">
            <img src={logo} alt="logo" />
            <h1 id="title_logo">筑库</h1>
          </Link>
        </div>
        <Menu
          key="Menu"
        ...
        {!collapsed ? <div className={styles.switchtheme} id="switchtheme">
          <span><Icon type="bulb" />切换 主题</span>
